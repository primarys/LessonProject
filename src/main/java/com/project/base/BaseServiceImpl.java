...
public abstract class BaseServiceImpl<T> implements BaseService<T> {
	...
	@Transactional
	public List<Object[]> findObjectsByHql(String hql, Map<String, Object> map) {
		return baseDao.findObjectsByHql(hql, map);
	}
	@Transactional
	// 获取实体对象的list集合
	...
	public String getJsonList(PageBean pageBean, Map<String, Object> map,
		...
		if (excludes == null) {
			excludes = new String[] {}; // 待添加
		}
		config.setExcludes(excludes);// 出去dept属性

...
public interface BaseService<T> {
	 ...
	 * @return
	 */
	public List<Object[]> findObjectsBySql(String sql, Map<String, Object> map);// 查询实体类中的某些属性
	 ...
	 * @return
	 */
	public int getCountBySql(String sql, Object[] params); // 原生sql查出总的记录数
	/**
	 * 
	 * @param hql
	 * @param map

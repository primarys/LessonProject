...
(function (X, l, n) {
    var L = function (h) {
        var j = function (e) {
            ...
            function ga(a) {
                ...
                a.aiDisplayTeacher.splice(0,
                    a.aiDisplayTeacher.length);
            ...
            function Fa(a, b) {
                ...
                a.aiDisplay = a.aiDisplayTeacher.slice();
                a.bAjaxDataGet = !1;
                x(a);
                a.bAjaxDataGet = !0;
                E(a, !1)
            ...
            function Ga(a, b, c, d, i, f) {
                ...
                if (0 >= b.length)a.aiDisplay.splice(0, a.aiDisplay.length), a.aiDisplay = a.aiDisplayTeacher.slice(); else if (a.aiDisplay.length == a.aiDisplayTeacher.length || i.sSearch.length > b.length || 1 == c || 0 !== b.indexOf(i.sSearch)) {
                    a.aiDisplay.splice(0,
                        a.aiDisplay.length);
                    la(a, 1);
                    for (b = 0; b < a.aiDisplayTeacher.length; b++)d.test(a.asDataSearch[b]) && a.aiDisplay.push(a.aiDisplayTeacher[b])
            ...
            function la(a, b) {
                if (!a.oFeatures.bServerSide) {
                    a.asDataSearch = [];
                    for (var c = r(a, "bSearchable"), d = 1 === b ? a.aiDisplayTeacher : a.aiDisplay, i = 0, f = d.length; i < f; i++)a.asDataSearch[i] = na(a, Y(a, d[i], "filter", c))
                }
            }
            ...
            function ba(a) {
                ...
                if (!1 === a.bInitialised)setTimeout(function () {
                    ...
                    a.oFeatures.bSort ? O(a) : a.oFeatures.bFilter ? K(a, a.oPreviousSearch) : (a.aiDisplay = a.aiDisplayTeacher.slice(), y(a), x(a));
            ...
            function O(a, b) {
                ...
                if (!a.oFeatures.bServerSide && (0 !== a.aaSorting.length || null !== a.aaSortingFixed)) {
                    ...
                    c =
                        0;
                    for (d = a.aiDisplayTeacher.length; c < d; c++)m[a.aiDisplayTeacher[c]] = c;
                    var r = o.length, s;
                    c = 0;
                    ...
                    a.aiDisplayTeacher.sort(function (a, b) {
                        var c, d, e, i, f;
                        for (c = 0; c < r; c++) {
                            f = q[o[c][0]].aDataSort;
                            d = 0;
                ...
                a.oFeatures.bFilter ? K(a, a.oPreviousSearch, 1) : (a.aiDisplay = a.aiDisplayTeacher.slice(), a._iDisplayStart = 0, y(a), x(a))
            }
            ...
            this.$ = function (a, b) {
                ...
                var g = d.aoData, o = d.aiDisplay, k = d.aiDisplayTeacher;
                b || (b = {});
            ...
            this.fnAddData = function (a, b) {
                ...
                e.aiDisplay = e.aiDisplayTeacher.slice();
                (b === n || b) && aa(e);
                return c
            };
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())D(null, 0, "Attempted to initialise DataTables on a node which is not a table: " +
                    ...
                    g.aiDisplay = g.aiDisplayTeacher.slice();
                    g.bInitialised = !0;
                    !1 === i && ba(g)
                }
            });
        ...
        j.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: {sFirst: "第 1 页", sLast: "最后 1 页", sNext: "<i class='fa fa-angle-right'></i>", sPrevious: "<i class='fa fa-angle-left'></i>"},
                sEmptyTable: "表格无数据",
                sInfo: "当前 _START_ 到 _END_ 记录，共 _TOTAL_ 条记录",
                sInfoEmpty: "共 0 条记录",
        ...
        j.models.oSettings = {
            ...
            fnRecordsTotal: function () {
                return this.oFeatures.bServerSide ? parseInt(this._iRecordsTotal, 10) : this.aiDisplayTeacher.length
            },
    ...
    "function" === typeof define && define.amd ? define(["jquery.min"], L) : jQuery && !jQuery.fn.dataTable &&
    L(jQuery)
})(window, document);
